...
use crate::{ARGS, Args, cluster::node::Node};
...
impl From<crate::byte_offset::ByteOffsetError> for DbError {
    fn from(err: crate::byte_offset::ByteOffsetError) -> Self {
        DbError::ByteOffset(err.to_string())
    }
}
